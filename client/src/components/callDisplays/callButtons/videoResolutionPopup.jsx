...
function VideoResolutionPopup({ displayState, setDisplayState, updateVideoResolution }) {
  return (
    <Popup displayState={ displayState } setDisplayState={ setDisplayState } >
      <div className={ classes.videoSettings }>
        ...
        <div className={ classes.settingsBox }>
          ...
          <Selector options={[ 'low', 'medium', 'high' ]} horizontal width="12.5ch" event={ e => updateVideoResolution( e, 'resolution' ) } />
        </div>
        <div className={ classes.settingsBox }>
