...
import HelpComponent from '../src/components/help/help';
...
function HelpPage({ dataArr }) {
  return (
    <>
      <Head>
        <title>Help - Secure Call</title>
      </Head>
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
...
export async function getStaticProps() {
  ...
  const dataArr = mapFileNamesToDisplayNames([
    browserSupport,
    testedBrowsers,
    troubleshooting,
  ]);
